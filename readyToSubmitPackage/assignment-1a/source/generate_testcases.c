...
int main()
{
	...
	for(testNumber=0;testNumber<20;testNumber++){
		...
		if(testNumber>=12 && testNumber<16){
			if(testNumber%4==0)//12
                                patternLength = 2000;
                        if(testNumber%4==1)//13
                                patternLength = 4000;
                        if(testNumber%4==2)//14
                                patternLength = 5000;
                        if(testNumber%4==3)//15
                                patternLength = 10000;
                        textLength = 100000000/patternLength;

		}
		if(testNumber>=16 && testNumber<20){
			if(testNumber%4==0)//16
				patternLength = 20000; 
			if(testNumber%4==1)//17
                                patternLength = 40000; 
			if(testNumber%4==2)//18
                                patternLength = 50000; 
			if(testNumber%4==3)//19
